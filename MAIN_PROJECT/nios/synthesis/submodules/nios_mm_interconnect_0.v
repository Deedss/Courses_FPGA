...
module nios_mm_interconnect_0 (
		...
		input  wire        vid_clk_clk_clk,                                //                              vid_clk_clk.clk
	...
	wire  [90:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> SW_s1_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // SW_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> SW_s1_agent:cp_channel
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> blue_s1_agent:cp_valid
	wire  [90:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> blue_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // blue_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> blue_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> blue_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> blue_s1_agent:cp_endofpacket
	...
	wire   [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> green_s1_agent:cp_channel
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> red_s1_agent:cp_valid
	wire  [90:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> red_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // red_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> red_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> red_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> red_s1_agent:cp_endofpacket
	...
	wire  [90:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [90:0] sw_s1_agent_rp_data;                                                                // SW_s1_agent:rp_data -> router_004:sink_data
	...
	wire         blue_s1_agent_rp_valid;                                                             // blue_s1_agent:rp_valid -> router_005:sink_valid
	wire  [90:0] blue_s1_agent_rp_data;                                                              // blue_s1_agent:rp_data -> router_005:sink_data
	wire         blue_s1_agent_rp_ready;                                                             // router_005:sink_ready -> blue_s1_agent:rp_ready
	wire         blue_s1_agent_rp_startofpacket;                                                     // blue_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         blue_s1_agent_rp_endofpacket;                                                       // blue_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         red_s1_agent_rp_valid;                                                              // red_s1_agent:rp_valid -> router_007:sink_valid
	wire  [90:0] red_s1_agent_rp_data;                                                               // red_s1_agent:rp_data -> router_007:sink_data
	wire         red_s1_agent_rp_ready;                                                              // router_007:sink_ready -> red_s1_agent:rp_ready
	wire         red_s1_agent_rp_startofpacket;                                                      // red_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         red_s1_agent_rp_endofpacket;                                                        // red_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [90:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [90:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> cmd_mux_006:sink1_data
	...
	wire  [90:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> rsp_mux_001:sink2_data
	...
	wire  [90:0] cmd_demux_src0_data;                                                                // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [90:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [90:0] cmd_demux_001_src0_data;                                                            // cmd_demux_001:src0_data -> crosser_001:in_data
	...
	wire  [90:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux:sink1_data
	...
	wire  [90:0] rsp_demux_src0_data;                                                                // rsp_demux:src0_data -> crosser_002:in_data
	...
	wire  [90:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink0_data
	...
	wire  [90:0] rsp_demux_src1_data;                                                                // rsp_demux:src1_data -> crosser_003:in_data
	...
	wire  [90:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink0_data
	...
	wire         blue_s1_agent_rdata_fifo_src_valid;                                                 // blue_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] blue_s1_agent_rdata_fifo_src_data;                                                  // blue_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         blue_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_003:in_0_ready -> blue_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> blue_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> blue_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // blue_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> blue_s1_agent:rdata_fifo_sink_error
	...
	wire         red_s1_agent_rdata_fifo_src_valid;                                                  // red_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] red_s1_agent_rdata_fifo_src_data;                                                   // red_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         red_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_005:in_0_ready -> red_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> red_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> red_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // red_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> red_s1_agent:rdata_fifo_sink_error
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_clk            (vid_clk_clk_clk),                                //        in_clk.clk
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (vid_clk_clk_clk),                                //       out_clk.clk
	...
	nios_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (vid_clk_clk_clk),                                         // in_clk_0.clk
