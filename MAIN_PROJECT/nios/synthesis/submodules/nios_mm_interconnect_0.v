...
module nios_mm_interconnect_0 (
	...
	wire  [91:0] altpll_0_pll_slave_agent_rf_source_data;                                            // altpll_0_pll_slave_agent:rf_source_data -> altpll_0_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [91:0] altpll_0_pll_slave_agent_rsp_fifo_out_data;                                         // altpll_0_pll_slave_agent_rsp_fifo:out_data -> altpll_0_pll_slave_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> altpll_0_pll_slave_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // altpll_0_pll_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [7:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> altpll_0_pll_slave_agent:cp_channel
	...
	wire  [91:0] sw_s1_agent_rf_source_data;                                                         // SW_s1_agent:rf_source_data -> SW_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] sw_s1_agent_rsp_fifo_out_data;                                                      // SW_s1_agent_rsp_fifo:out_data -> SW_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> SW_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // SW_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> SW_s1_agent:cp_channel
	...
	wire  [90:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> blue_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // blue_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> blue_s1_agent:cp_channel
	...
	wire  [90:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> green_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // green_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> green_s1_agent:cp_channel
	...
	wire  [90:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> red_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // red_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> red_s1_agent:cp_channel
	...
	wire  [90:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [90:0] altpll_0_pll_slave_agent_rp_data;                                                   // altpll_0_pll_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [90:0] sw_s1_agent_rp_data;                                                                // SW_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [90:0] blue_s1_agent_rp_data;                                                              // blue_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [90:0] green_s1_agent_rp_data;                                                             // green_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [90:0] red_s1_agent_rp_data;                                                               // red_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [90:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [90:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> cmd_mux_007:sink1_data
	...
	wire  [90:0] rsp_demux_007_src1_data;                                                            // rsp_demux_007:src1_data -> rsp_mux_001:sink2_data
	...
	wire  [90:0] cmd_demux_src2_data;                                                                // cmd_demux:src2_data -> crosser:in_data
	...
	wire  [90:0] crosser_out_data;                                                                   // crosser:out_data -> cmd_mux_002:sink0_data
	...
	wire  [90:0] rsp_demux_002_src0_data;                                                            // rsp_demux_002:src0_data -> crosser_001:in_data
	...
	wire  [90:0] crosser_001_out_data;                                                               // crosser_001:out_data -> rsp_mux:sink2_data
	wire         crosser_001_out_ready;                                                              // rsp_mux:sink2_ready -> crosser_001:out_ready
	wire   [7:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> rsp_mux:sink2_channel
