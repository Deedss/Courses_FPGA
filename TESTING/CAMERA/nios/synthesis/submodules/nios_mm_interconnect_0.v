...
module nios_mm_interconnect_0 (
	...
	wire  [91:0] red_s1_agent_rf_source_data;                                                        // red_s1_agent:rf_source_data -> red_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] red_s1_agent_rsp_fifo_out_data;                                                     // red_s1_agent_rsp_fifo:out_data -> red_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> red_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // red_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [7:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> red_s1_agent:cp_channel
	...
	wire  [91:0] green_s1_agent_rf_source_data;                                                      // green_s1_agent:rf_source_data -> green_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] green_s1_agent_rsp_fifo_out_data;                                                   // green_s1_agent_rsp_fifo:out_data -> green_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> green_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // green_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> green_s1_agent:cp_channel
	...
	wire  [91:0] blue_s1_agent_rf_source_data;                                                       // blue_s1_agent:rf_source_data -> blue_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] blue_s1_agent_rsp_fifo_out_data;                                                    // blue_s1_agent_rsp_fifo:out_data -> blue_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> blue_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // blue_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> blue_s1_agent:cp_channel
	...
	wire  [91:0] h_cont_s1_agent_rf_source_data;                                                     // H_Cont_s1_agent:rf_source_data -> H_Cont_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] h_cont_s1_agent_rsp_fifo_out_data;                                                  // H_Cont_s1_agent_rsp_fifo:out_data -> H_Cont_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> H_Cont_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // H_Cont_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> H_Cont_s1_agent:cp_channel
	...
	wire  [91:0] v_cont_s1_agent_rf_source_data;                                                     // V_Cont_s1_agent:rf_source_data -> V_Cont_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] v_cont_s1_agent_rsp_fifo_out_data;                                                  // V_Cont_s1_agent_rsp_fifo:out_data -> V_Cont_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> V_Cont_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // V_Cont_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> V_Cont_s1_agent:cp_channel
	...
	wire  [90:0] red_s1_agent_rp_data;                                                               // red_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [90:0] green_s1_agent_rp_data;                                                             // green_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [90:0] blue_s1_agent_rp_data;                                                              // blue_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [90:0] h_cont_s1_agent_rp_data;                                                            // H_Cont_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [90:0] v_cont_s1_agent_rp_data;                                                            // V_Cont_s1_agent:rp_data -> router_009:sink_data
