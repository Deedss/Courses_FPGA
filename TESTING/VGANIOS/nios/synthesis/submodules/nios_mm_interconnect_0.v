...
module nios_mm_interconnect_0 (
	...
	wire  [107:0] rsp_mux_src_data;                                                                            // rsp_mux:src_data -> video_dma_controller_0_avalon_dma_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                           // video_dma_controller_0_avalon_dma_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [5:0] rsp_mux_src_channel;                                                                         // rsp_mux:src_channel -> video_dma_controller_0_avalon_dma_master_agent:rp_channel
	...
	wire  [108:0] video_dma_controller_0_avalon_dma_control_slave_agent_rf_source_data;                        // video_dma_controller_0_avalon_dma_control_slave_agent:rf_source_data -> video_dma_controller_0_avalon_dma_control_slave_agent_rsp_fifo:in_data
	...
	wire  [108:0] video_dma_controller_0_avalon_dma_control_slave_agent_rsp_fifo_out_data;                     // video_dma_controller_0_avalon_dma_control_slave_agent_rsp_fifo:out_data -> video_dma_controller_0_avalon_dma_control_slave_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_001_src_data;                                                                        // cmd_mux_001:src_data -> video_dma_controller_0_avalon_dma_control_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                                       // video_dma_controller_0_avalon_dma_control_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                                                     // cmd_mux_001:src_channel -> video_dma_controller_0_avalon_dma_control_slave_agent:cp_channel
	...
	wire  [107:0] video_dma_controller_0_avalon_dma_master_agent_cp_data;                                      // video_dma_controller_0_avalon_dma_master_agent:cp_data -> router:sink_data
	...
	wire  [107:0] video_dma_controller_0_avalon_dma_control_slave_agent_rp_data;                               // video_dma_controller_0_avalon_dma_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire    [5:0] sram_0_avalon_sram_slave_burst_adapter_source0_channel;                                      // sram_0_avalon_sram_slave_burst_adapter:source0_channel -> sram_0_avalon_sram_slave_agent:cp_channel
	...
	wire    [5:0] cmd_demux_002_src1_channel;                                                                  // cmd_demux_002:src1_channel -> cmd_mux_005:sink1_channel
	...
	wire    [5:0] rsp_demux_005_src1_channel;                                                                  // rsp_demux_005:src1_channel -> rsp_mux_002:sink1_channel
	...
	wire    [5:0] router_003_src_channel;                                                                      // router_003:src_channel -> sram_0_avalon_sram_slave_rsp_width_adapter:in_channel
	...
	wire    [5:0] sram_0_avalon_sram_slave_rsp_width_adapter_src_channel;                                      // sram_0_avalon_sram_slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire    [5:0] cmd_mux_src_channel;                                                                         // cmd_mux:src_channel -> sram_0_avalon_sram_slave_cmd_width_adapter:in_channel
	...
	wire    [5:0] sram_0_avalon_sram_slave_cmd_width_adapter_src_channel;                                      // sram_0_avalon_sram_slave_cmd_width_adapter:out_channel -> sram_0_avalon_sram_slave_burst_adapter:sink0_channel
	...
	wire          video_dma_controller_0_avalon_dma_control_slave_agent_rdata_fifo_out_valid;                  // video_dma_controller_0_avalon_dma_control_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] video_dma_controller_0_avalon_dma_control_slave_agent_rdata_fifo_out_data;                   // video_dma_controller_0_avalon_dma_control_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          video_dma_controller_0_avalon_dma_control_slave_agent_rdata_fifo_out_ready;                  // avalon_st_adapter_001:in_0_ready -> video_dma_controller_0_avalon_dma_control_slave_agent_rdata_fifo:out_ready
	...
	wire          jtag_uart_0_avalon_jtag_slave_agent_rdata_fifo_out_valid;                                    // jtag_uart_0_avalon_jtag_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] jtag_uart_0_avalon_jtag_slave_agent_rdata_fifo_out_data;                                     // jtag_uart_0_avalon_jtag_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          jtag_uart_0_avalon_jtag_slave_agent_rdata_fifo_out_ready;                                    // avalon_st_adapter_002:in_0_ready -> jtag_uart_0_avalon_jtag_slave_agent_rdata_fifo:out_ready
